package com.pesanmerpati.uberclonev2.Activities;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showLoginDialog() {
        ...
        mDialog.setMessage("Please use email to sign in");
        ...
        mDialog.setView(login_layout);

        mDialog.setPositiveButton("SIGN IN", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void showRegisterDialog() {
        ...
        mDialog.setMessage("Please use email to register");
        ...
        mDialog.setPositiveButton("REGISTER", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                if (TextUtils.isEmpty(edtEmail.getText().toString())) {
